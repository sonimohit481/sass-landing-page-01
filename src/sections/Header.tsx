  ...
  return (
    <header className=" fixed top-0 left-0 z-50 w-full py-10">
      <div className=" container flex h-14 items-center max-lg:px-5">
        ...
        <div
          className={clsx(
            "w-full max-lg:fixed mnax-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0",
        ...
        >
          <div className="max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen  max-lg:p-6 max-lg:overflow-hidden sidebar-before">
            ...
            <div className=" lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px ] translate-x-[-29-px] -translate-y-1/2 rotate-90">
              <img
